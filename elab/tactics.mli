...
(** [exists a] takes in a term [a] of type [A], and constructs a new goal [p a],
    where the old goal had form [Exists A p]. The motive [p] is inferred from
    the goal and the type of the argument [a]. *)
