...
(** The [distinct_points] tactic takes a [distinct_from] proof as an argument, and from it
    proves an inequality between points and adds it to the hypotheses, asking for the
    [List.mem] proof obligation for now (future versions will probably try to prove this
